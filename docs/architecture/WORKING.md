# How Etherana SX Works

This is a high level overview of how Etherana SX answers a question.
...
If you are integrating Etherana SX into another product, you can call `POST /api/search`.
